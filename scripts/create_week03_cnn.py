#!/usr/bin/env python3
"""
Week 03 Starter: CNN From Scratch
High-Value Sprint - Deep Learning Core
"""
...
if __name__ == "__main__":
    print("🚀 Creating Week 03: CNN notebook...\n")
    
    notebook = nb(cnn_cells)
    output = BASE_DIR / "01_cnn_from_scratch.ipynb"
    output.parent.mkdir(parents=True, exist_ok=True)
    
    with open(output, 'w', encoding='utf-8') as f:
        json.dump(notebook, f, indent=2)
    
    print("✅ 01_cnn_from_scratch.ipynb")
    print("\n🎉 Week 03 started! Next: Backpropagation, Architectures, Transfer Learning")
