...
def sample_arabic_document() -> Dict[str, Any]:
    ...
    return {
        "id": "test_arabic_001",
        "content": """
Ù…Ù‚Ø¯Ù…Ø© ÙÙŠ ØªØ¹Ù„Ù… Ø§Ù„Ø¢Ù„Ø©

ØªØ¹Ù„Ù… Ø§Ù„Ø¢Ù„Ø© Ù‡Ùˆ ÙØ±Ø¹ Ù…Ù† ÙØ±ÙˆØ¹ Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ ÙŠÙÙ…ÙƒÙ‘Ù† Ø§Ù„Ø£Ù†Ø¸Ù…Ø© Ù…Ù† Ø§Ù„ØªØ¹Ù„Ù… 
ÙˆØ§Ù„ØªØ­Ø³ÙŠÙ† Ù…Ù† Ø§Ù„Ø®Ø¨Ø±Ø© Ø¯ÙˆÙ† Ø£Ù† ØªØªÙ… Ø¨Ø±Ù…Ø¬ØªÙ‡Ø§ ØµØ±Ø§Ø­Ø©Ù‹. ÙŠØ±ÙƒØ² Ø¹Ù„Ù‰ ØªØ·ÙˆÙŠØ± Ø¨Ø±Ø§Ù…Ø¬ 
Ø§Ù„Ø­Ø§Ø³ÙˆØ¨ Ø§Ù„ØªÙŠ ÙŠÙ…ÙƒÙ†Ù‡Ø§ Ø§Ù„ÙˆØµÙˆÙ„ Ø¥Ù„Ù‰ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª ÙˆØ§Ø³ØªØ®Ø¯Ø§Ù…Ù‡Ø§ Ù„Ù„ØªØ¹Ù„Ù… Ø¨Ù†ÙØ³Ù‡Ø§.

ØªØ¨Ø¯Ø£ Ø§Ù„Ø¹Ù…Ù„ÙŠØ© Ø¨Ù…Ù„Ø§Ø­Ø¸Ø§Øª Ø£Ùˆ Ø¨ÙŠØ§Ù†Ø§ØªØŒ Ù…Ø«Ù„ Ø§Ù„Ø£Ù…Ø«Ù„Ø© Ø£Ùˆ Ø§Ù„Ø®Ø¨Ø±Ø© Ø§Ù„Ù…Ø¨Ø§Ø´Ø±Ø©ØŒ 
Ù…Ù† Ø£Ø¬Ù„ Ø§Ù„Ø¨Ø­Ø« Ø¹Ù† Ø£Ù†Ù…Ø§Ø· ÙÙŠ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª ÙˆØ§ØªØ®Ø§Ø° Ù‚Ø±Ø§Ø±Ø§Øª Ø£ÙØ¶Ù„ ÙÙŠ Ø§Ù„Ù…Ø³ØªÙ‚Ø¨Ù„.

Ø£Ù†ÙˆØ§Ø¹ ØªØ¹Ù„Ù… Ø§Ù„Ø¢Ù„Ø©

Ù¡. Ø§Ù„ØªØ¹Ù„Ù… Ø§Ù„Ø®Ø§Ø¶Ø¹ Ù„Ù„Ø¥Ø´Ø±Ø§Ù: ØªØªØ¹Ù„Ù… Ø§Ù„Ø®ÙˆØ§Ø±Ø²Ù…ÙŠØ© Ù…Ù† Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„ØªØ¯Ø±ÙŠØ¨ Ø§Ù„Ù…ÙˆØ³ÙˆÙ…Ø©.
Ù¢. Ø§Ù„ØªØ¹Ù„Ù… ØºÙŠØ± Ø§Ù„Ø®Ø§Ø¶Ø¹ Ù„Ù„Ø¥Ø´Ø±Ø§Ù: ØªØ¬Ø¯ Ø§Ù„Ø®ÙˆØ§Ø±Ø²Ù…ÙŠØ© Ø£Ù†Ù…Ø§Ø·Ø§Ù‹ ÙÙŠ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª ØºÙŠØ± Ø§Ù„Ù…ÙˆØ³ÙˆÙ…Ø©.
Ù£. Ø§Ù„ØªØ¹Ù„Ù… Ø§Ù„ØªØ¹Ø²ÙŠØ²ÙŠ: ØªØªØ¹Ù„Ù… Ø§Ù„Ø®ÙˆØ§Ø±Ø²Ù…ÙŠØ© Ù…Ù† Ø®Ù„Ø§Ù„ Ø§Ù„ØªØ¬Ø±Ø¨Ø© ÙˆØ§Ù„Ø®Ø·Ø£.

Ø§Ù„Ø®Ø§ØªÙ…Ø©

ÙŠØ³ØªÙ…Ø± ØªØ¹Ù„Ù… Ø§Ù„Ø¢Ù„Ø© ÙÙŠ Ø§Ù„ØªØ·ÙˆØ± ÙˆØ¥ÙŠØ¬Ø§Ø¯ ØªØ·Ø¨ÙŠÙ‚Ø§Øª Ø¬Ø¯ÙŠØ¯Ø© ÙÙŠ Ù…Ø¬Ø§Ù„Ø§Øª Ù…Ø®ØªÙ„ÙØ© 
Ø¨Ù…Ø§ ÙÙŠ Ø°Ù„Ùƒ Ø§Ù„Ø±Ø¹Ø§ÙŠØ© Ø§Ù„ØµØ­ÙŠØ© ÙˆØ§Ù„Ù…Ø§Ù„ÙŠØ© ÙˆØ§Ù„Ù†Ù‚Ù„ ÙˆØ§Ù„ØªØ±ÙÙŠÙ‡.
""".strip(),
        "metadata": {
...
class TestEdgeCases:
    ...
    def test_unicode_content(self) -> None:
        ...
        doc = {
            "id": "unicode",
            "content": "Hello ä¸–ç•Œ ðŸŒ Ù…Ø±Ø­Ø¨Ø§ ×©×œ×•×",
        }
