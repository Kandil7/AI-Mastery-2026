...
from src.rag.specialized.integration_layer import (
...
class TestContinualLearningRAG(unittest.TestCase):
    ...
    def test_experience_buffer(self):
        ...
        from src.rag.specialized.continual_learning.continual_learning_rag import LearningExperience
...
class TestIntegrationLayer(unittest.TestCase):
    ...
    def test_backward_compatibility(self):
        ...
        from src.rag.specialized.integration_layer import BackwardCompatibilityLayer
