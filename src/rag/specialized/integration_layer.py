...
# Note: Legacy RAG classes have been archived to archive/legacy/rag/
# This module now uses the unified interface with specialized RAG architectures directly

# Import specialized RAG architectures
try:
    from src.rag.specialized.adaptive_multimodal.adaptive_multimodal_rag import (
...
try:
    from src.rag.specialized.temporal_aware.temporal_aware_rag import (
...
try:
    from src.rag.specialized.graph_enhanced.graph_enhanced_rag import (
...
try:
    from src.rag.specialized.privacy_preserving.privacy_preserving_rag import (
...
try:
    from src.rag.specialized.continual_learning.continual_learning_rag import (
...
class AdaptiveMultiModalAdapter(RAGAdapter):
    ...
    def add_documents(self, documents: List[UnifiedDocument]) -> int:
        ...
        from src.rag.specialized.adaptive_multimodal.adaptive_multimodal_rag import MultiModalDocument
    ...
    def query(self, query: UnifiedQuery, k: int = 5) -> UnifiedGenerationResult:
        ...
        from src.rag.specialized.adaptive_multimodal.adaptive_multimodal_rag import MultiModalQuery
...
class TemporalAwareAdapter(RAGAdapter):
    ...
    def add_documents(self, documents: List[UnifiedDocument]) -> int:
        ...
        from src.rag.specialized.temporal_aware.temporal_aware_rag import TemporalDocument
    ...
    def query(self, query: UnifiedQuery, k: int = 5) -> UnifiedGenerationResult:
        ...
        from src.rag.specialized.temporal_aware.temporal_aware_rag import TemporalQuery
        from src.rag.specialized.temporal_aware.temporal_aware_rag import TemporalScope
...
class GraphEnhancedAdapter(RAGAdapter):
    ...
    def add_documents(self, documents: List[UnifiedDocument]) -> int:
        ...
        from src.rag.specialized.graph_enhanced.graph_enhanced_rag import GraphDocument
    ...
    def query(self, query: UnifiedQuery, k: int = 5) -> UnifiedGenerationResult:
        ...
        from src.rag.specialized.graph_enhanced.graph_enhanced_rag import GraphQuery
...
class PrivacyPreservingAdapter(RAGAdapter):
    ...
    def __init__(self):
        from src.rag.specialized.privacy_preserving.privacy_preserving_rag import PrivacyConfig
    ...
    def add_documents(self, documents: List[UnifiedDocument]) -> int:
        ...
        from src.rag.specialized.privacy_preserving.privacy_preserving_rag import PrivacyDocument, PrivacyLevel
    ...
    def query(self, query: UnifiedQuery, k: int = 5) -> UnifiedGenerationResult:
        ...
        from src.rag.specialized.privacy_preserving.privacy_preserving_rag import PrivacyQuery, PrivacyLevel
...
class ContinualLearningAdapter(RAGAdapter):
    ...
    def add_documents(self, documents: List[UnifiedDocument]) -> int:
        ...
        from src.rag.specialized.continual_learning.continual_learning_rag import ContinualDocument
    ...
    def query(self, query: UnifiedQuery, k: int = 5) -> UnifiedGenerationResult:
        ...
        from src.rag.specialized.continual_learning.continual_learning_rag import ContinualQuery
