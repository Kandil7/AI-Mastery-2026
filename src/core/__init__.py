...
from src.core.adaptive_integration import AdaptiveIntegrator, FunctionFeatures

# Phase 10: RL Integration and Causal Inference
from src.core.rl_integration import RLIntegrationSystem, Episode, PolicyGradientResult
from src.core.causal_inference import CausalInferenceSystem, ATEResult, CATEResult
...
# Federated Learning
from src.core.federated_learning import (
    FederatedConfig,
    AggregationMethod,
    ClientUpdate,
    ServerState,
