...
# Math operations - use numpy directly or import from foundation_utils
from src.core.utils.foundation_utils import (
    dot as dot_product,
    magnitude,
    cosine_similarity,
    matrix_multiply,
...
from src.core.optimization import Adam, GradientDescent as SGD
from src.ml.classical_scratch import (
    LinearRegressionScratch, LogisticRegressionScratch,
    DecisionTreeScratch, RandomForestScratch
)
from src.ml.neural_networks_scratch import (
...
# Simple LRU Cache for benchmarks (original LRUCache not available)
class LRUCache:
    """Simple LRU cache for benchmark purposes."""
    ...
    def put(self, key, value):
        ...
        self.order.append(key)
from src.llm.benchmarks.performance_evaluation import (
    BenchmarkSuite, ModelBenchmark, AlgorithmBenchmark,
    ScalabilityBenchmark, PerformanceMetrics
)


# Note: Legacy RAG classes archived to archive/legacy/rag/
# Using simple local definitions for benchmark compatibility
class Document:
    """Simple document class for RAG benchmarks."""
...
class RAGPipeline:
    """Simple RAG pipeline for benchmark purposes."""
    def __init__(self):
        self.documents = []
    ...
    def query(self, query: str, k: int = 5) -> list:
        # Simple keyword-based retrieval for benchmarks
