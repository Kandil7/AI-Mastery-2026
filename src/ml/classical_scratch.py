...
try:
    from src.core.utils.foundation_utils import sigmoid, softmax
    from src.core.optimization import GradientDescent as SGD, Adam
except ImportError:
    from ..core.utils.foundation_utils import sigmoid, softmax
    from ..core.optimization import GradientDescent as SGD, Adam


def l2_regularization(weights: np.ndarray, lambda_: float = 0.01) -> float:
