...
class FixedSizeChunker(BaseChunker):
    ...
    def __init__(self, chunk_size: int = 512, overlap: int = 100, separator: str = " "):
    ...
    def chunk(self, document: Document) -> List[DocumentChunk]:
        ...
        while i < len(boundaries) - 1:
            ...
            if end - start > self.max_chunk_size:
                    ...
                    boundaries[end_idx - 1]
                    if end_idx > i + 1
                    else start + self.max_chunk_size
                )
...
class HierarchicalChunker(BaseChunker):
    ...
    def get_parent(
        self, child_chunk: DocumentChunk, all_chunks: List[DocumentChunk]
...
class ProductionDataPipeline:
    ...
    def process(
        self, content: str, format: str = "text", doc_id: Optional[str] = None
    ) -> List[DocumentChunk]:
        """
    ...
    def process_batch(self, documents: List[Dict[str, str]]) -> List[DocumentChunk]:
        """
